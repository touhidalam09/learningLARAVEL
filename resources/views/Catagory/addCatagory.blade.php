        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        {{Form::open(['route' => 'addNewCatagory'])}}
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    {{ Form::label('catagoryName', 'Catagory Name', ['class'=>'bmd-label-floating'])}}
                                    {{ Form::text('catagoryName', '', ['class'=>'form-control', 'id'=>'catagoryName', 'required' => 'required', 'onblur'=>'ajaxFun()' ])}}
                        ...
                        {{Form::submit('Add Catagory',['id'=>'addCatagoryBtn', 'class'=>'btn btn-primary pull-right'])}}
